...
export const CanvasProvider = ({ children }) => {
    ...
    const [texts, setTexts] = useState([
        { id: 1, text: "Your Text Here", x: 300, y: 50, rotation: 0, isDragging: false },
    ]);
    ...
    const drawText = (ctx, { text, x, y, rotation }) => {
        ...
        const gradient = ctx.createLinearGradient(12, textHeight / 2, textHeight / 2, 12);
    ...
    const addNewText = () => {
        ...
        setTexts((prev) => [
            ...prev,
            { id: newId, text: "New Text", x: 100, y: 100, rotation: 0, isDragging: false },
        ]);
    };
